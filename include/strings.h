...
extern const u8 gText_RotomHeatAndPrice[];
extern const u8 gText_RotomWashAndPrice[];
extern const u8 gText_RotomFrostAndPrice[];
extern const u8 gText_RotomFanAndPrice[];
extern const u8 gText_RotomMowAndPrice[];
